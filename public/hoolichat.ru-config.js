...
var config = {
    ...
    hosts: {
        // XMPP domain.
        domain: 'confee.tfnopt.ru',

        // When using authentication, domain for guest users.
        // anonymousdomain: 'guest.example.com',

        // Domain for authenticated users. Defaults to <domain>.
        authdomain: 'auth.confee.tfnopt.ru',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.confee.tfnopt.ru',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'confee.tfnopt.ru',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: '//confee.tfnopt.ru/' + subdir + 'http-bind',

    // Websocket URL
    // websocket: 'wss://confee.tfnopt.ru/' + subdir + 'xmpp-websocket',

    // The real JID of focus participant - can be overridden here
    // Do not change username - FIXME: Make focus username configurable
    // https://github.com/jitsi/jitsi-meet/issues/7376
    // focusUserJid: 'focus@auth.confee.tfnopt.ru',
    ...
    //     // by default uses:
    //     // 'https://confee.tfnopt.ru/static/oauth.html'
    //     redirectURI:
    //          'https://confee.tfnopt.ru/subfolder/static/oauth.html',
    // },
    ...
    p2p: {
        ...
        stunServers: [
            ...
            // { urls: 'stun:confee.tfnopt.ru:3478' },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.confee.tfnopt.ru',
