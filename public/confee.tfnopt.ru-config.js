...
var config = {
    ...
    hosts: {
        // XMPP domain.
        domain: 'cloud.confee.ru',

        // When using authentication, domain for guest users.
        // anonymousdomain: 'guest.example.com',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'cloud.confee.ru',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.cloud.confee.ru',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'cloud.confee.ru',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: '//cloud.confee.ru/' + subdir + 'http-bind',

    // Websocket URL
    // websocket: 'wss://cloud.confee.ru/' + subdir + 'xmpp-websocket',

    // The real JID of focus participant - can be overridden here
    // Do not change username - FIXME: Make focus username configurable
    // https://github.com/jitsi/jitsi-meet/issues/7376
    // focusUserJid: 'focus@auth.cloud.confee.ru',
    ...
    //     // by default uses:
    //     // 'https://cloud.confee.ru/static/oauth.html'
    //     redirectURI:
    //          'https://cloud.confee.ru/subfolder/static/oauth.html',
    // },
    ...
    p2p: {
        ...
        stunServers: [
            ...
            // { urls: 'stun:cloud.confee.ru:3478' },
    ...
    // moderatedRoomServiceUrl: 'https://moderated.cloud.confee.ru',
