...
class WelcomePage extends AbstractWelcomePage {
        ...
        return (
            ...
            >
                ...
                <main style={styles.main}>
                    <div style={styles.conferenceBlock}>
                        <div style={{ width: "61%" }}>
                            <input
                                type="text"
                            ...
                            {/*    sx={{*/}
                            {/*        width: "calc(100% - 20px)",*/}
                            {/*        input: { color: 'white', borderColor: "#fff" }*/}
                            {/*    }}*/}
                            {/*    helperText={this.state.conferenceNameError}*/}
                            {/*    error={!!this.state.conferenceNameError}*/}
                            {/*    onChange={(event) => {*/}
                            {/*        if (event.target.value.length < 31) {*/}
                            {/*            this.setState({*/}
                        ...
                        <Button
                            ...
                            onClick={() => {
                                if (
                                    ...
                                    (this.state.currentPin &&
                                        this.state.currentPin?.length < 4)
                                ) {
                                    this.setState({
                                        pinError:
                                            "Пин-код должен состоять как минимум из 4 цифр",
                                    });
                                } else {
                                    this.setState({
                                        pinError: null,
                ...
                <aside style={styles.aside}>
                    <h2 style={{ fontSize: "25px", padding: "20px" }}>
                        Мои конференции
                    </h2>
                    {_isAuthenticated() &&
                ...
                >
                    ...
                    <DialogActions>
                        ...
                        <Button
                            ...
                            onClick={() => {
                                deleteConference(
                                    this.state.targetConferenceForDelete?.id
                                ).then(() => {
                                    this.setState({
                                        deleteConferenceModalOpen: false,
                                    });
                ...
                {this.state.targetConference && (
                    <Popper
                        ...
                        style={{
                            ...
                            borderRadius: "5px",
                            maxWidth:
                                window.innerWidth < 440 ? "300px" : "440px",
                        }}
                    >
                        <Box className="confee-share-list">
                            <InviteByEmailSection
                                inviteSubject={
                                    "Confee. Приглашение в конференцию"
                                }
                                inviteText={
                                    this.state.targetConference.display_name
                                }
            ...
            //             <div
            //                 className="header-watermark-container"
            //                 style={{ top: 0 }}
            //             >
            ...
            //             {!_isAuthenticated() && (
            //                 <>
            //                     <div style={{ fontSize: "20px", zIndex: 1 }}>
            //                         Для создания конференции необходимо{" "}
            //                         <span
            //                             style={{
            //                                 color: "#2568f7",
            //                                 cursor: "pointer",
            ...
            //     >
            //         {!!this.state.conferenceList?.length && (
            //             <Box sx={{ height: "283px", overflow: "auto" }}>
            //                 {this.state.conferenceList.map((conference) => (
            //                     <Box
            //                         sx={{
            //                             display: "flex",
            ...
            //     </div>
            //     <Dialog
            //         open={this.state.newConfModalOpen}
            //         onClose={() =>
            //             this.setState({
            //                 newConfModalOpen: false,
            //             })
            ...
            //         <DialogContent>
            //             <DialogContentText id="alert-dialog-description">
            //                 Создайте конференцию и поделитесь с теми кого хотите
            //                 пригласить.
            //             </DialogContentText>
            //             <TextField
            //                 value={this.state.currentName}
    ...
    _handleClick(event) {
        ...
        if (!this.state.currentName) {
            const randomRoomName = `Моя конференция ${this._makeRandomNumber(
                3
            )}`;
            this.setState({
